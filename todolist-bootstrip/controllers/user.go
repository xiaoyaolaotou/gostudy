...
func UserAction(w http.ResponseWriter, r *http.Request) {
	...
	tpl := template.Must(template.ParseFiles("views/layouts/base.html", "views/user/user.html"))
	tpl.ExecuteTemplate(w, "base.html", Context)
...
func UserCreateAction(w http.ResponseWriter, r *http.Request) {
	...
	tpl := template.Must(template.ParseFiles("views/layouts/base.html", "views/user/create.html"))
	tpl.ExecuteTemplate(w, "base.html", context)
}
